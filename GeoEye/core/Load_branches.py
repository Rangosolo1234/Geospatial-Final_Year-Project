...
# Auto-generated `LayerMapping` dictionary for Branches model
branches_mapping = {
    'name': 'Name',
...
branch_shp = os.path.abspath(os.path.join(os.path.dirname(__file__), 'geodata', 'Branches.shp'))
...
def run(verbose=True):
    lm = LayerMapping(Branches, branch_shp, branches_mapping, transform=False, encoding='iso-8859-1')
    #To save into our db
